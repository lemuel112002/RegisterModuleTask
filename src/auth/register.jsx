...
export default function Register() {
    ...
    const goToStep = (num) => {
        setStep(num); // Update the step state
    };
    ...
    return (
        <div className="container mt-5 mb-5">
            ...
            <div className="card shadow-lg p-4">
                ...
                {/* Stepper Navigation */}
                <div className="d-flex justify-content-between align-items-center stepper-container">
                    {[1, 2, 3, 4, 5].map((num, index) => (
                        <div key={num} className="step-wrapper text-center">
                            <div
                                className={`step-circle ${num <= step ? "active" : ""} rounded-circle`}
                ...
                <div className="row mt-4">
                        ...
                        <>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-12 col-md-6 text-end">
                                    <button type="button" className="btn btn-primary w-100" onClick={() => goToStep(2)}>NEXT STEP</button>
                                </div>
                            </div>
                        </>
                    )}
                    ...
                    {step === 2 && (
                        <>
                            ...
                            <div className="row mb-3">
                                <div className="col-12 col-md-6">
                                    <button type="button" className="btn btn-danger w-100" onClick={() => goToStep(1)}>PREVIOUS</button>
                                </div>
                                <div className="col-12 col-md-6 text-end">
                                    <button type="button" className="btn btn-primary w-100" onClick={() => goToStep(3)}>NEXT STEP</button>
                                </div>
                            </div>
                        </>
                    )}
                    ...
                    {step === 3 && (
                        <>
                            ...
                            <div className="row mb-3">
                                <div className="col-12 col-md-6">
                                    <button type="button" className="btn btn-danger w-100" onClick={() => goToStep(2)}>PREVIOUS</button>
                                </div>
                                <div className="col-12 col-md-6 text-end">
                                    <button type="button" className="btn btn-primary w-100" onClick={() => goToStep(4)}>NEXT STEP</button>
                                </div>
                            </div>
                        </>
                    )}
                    ...
                    {step === 4 && (
                        <>
                            ...
                            <div className="row mb-3">
                                <div className="col-12 col-md-6">
                                    <button type="button" className="btn btn-danger w-100" onClick={() => goToStep(3)}>PREVIOUS</button>
                                </div>
                                <div className="col-12 col-md-6 text-end">
                                    <button type="button" className="btn btn-primary w-100" onClick={() => goToStep(5)}>NEXT STEP</button>
                                </div>
                            </div>
                        </>
                    )}
                    ...
                    {step === 5 && (
                        <>
                            ...
                            <div className="row mb-3">
                                <div className="col-12 col-md-6">
                                    <button type="button" className="btn btn-danger w-100" onClick={() => goToStep(4)}>PREVIOUS</button>
                                </div>
                                <div className="col-12 col-md-6 text-end">
